...
function parseRaml(source, cb, outputFile) {
    ...
    function onSuccess(result) {
        ...
        console.log('result from parseRaml');
        console.log(result);
...
if (require.main === module) {
    ...
    async.map(inputFiles, function processFile(file, cb) {
       ...
       // console.log('Processing File Name : ' + file);
        ...
        console.log(outfileForSidebar);
        //program.outputPath = path.join(program.outputDir, file.replace(/raml$/, 'html'));
     ...
     //   console.log('Processing File Full Path : ' + inputFilePath);
        ...
        //     console.log(sidebarSection);
            ...
            // console.log('------------Can we has output files?----------');
            // console.log(outputFiles);
            // console.log('---------------------------')

            //  console.log('------------Can we has inputFiles?----------');
